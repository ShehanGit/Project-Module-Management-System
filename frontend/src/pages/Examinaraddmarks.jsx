...
export default function Examinarmarkadd() {
  ...
  const saveExamDetail = async (e) => {
    e.preventDefault();

    const exam = { ID, name, proposal, progress1, progress2 };

    try {
      // Assuming you have an API endpoint for saving exam details
      ...
      if (response.ok) {
        console.log('Exam details saved successfully!');
        ...
        console.error('Error saving exam details:', response.statusText);
      }
    } catch (error) {
